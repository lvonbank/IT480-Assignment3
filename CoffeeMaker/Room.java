...
public class Room
{
  ...
  public Room(boolean hasCoffee, boolean hasCream, boolean hasSugar, boolean northExit, boolean southExit) {
  ...
  private String generateDescription() {
    ...
    if (_northExit) {
      toReturn = toReturn + "A " + getAdjective() + " door leads North.\n";
    }
    
    if (_southExit) {
      toReturn = toReturn + "A " + getAdjective() + " door leads South.\n";
    }
